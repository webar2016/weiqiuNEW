...
-(void)checkInGroup{
    [MyDownLoadManager getNsurl:[NSString stringWithFormat:@"%@/hg/checkIn?userId=%@&groupId=%ld",WEBAR_IP,[WBUserDefaults userId],(long)self.model.groupId] whenSuccess:^(id representData) {
