...
-(instancetype)init{
    if (self = [super init]) {
        ...
        icon.frame = CGRectMake(SCREENWIDTH / 2 - 40, 20, 80, 80);
        [self.view addSubview:icon];
        
        UILabel *title = [[UILabel alloc] initWithFrame:CGRectMake(0, 120, SCREENWIDTH, 30)];
        title.text = @"微球  1.0";
        ...
        introduction.frame = (CGRect){{20, 170},{size.width,size.height + 100}};
        introduction.textColor = [UIColor initWithNormalGray];
        introduction.font = BIGFONTSIZE;
