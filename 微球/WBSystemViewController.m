...
- (RCMessageContent *)willSendMessage:(RCMessageContent *)messageCotent{
    ...
    if ([messageCotent isKindOfClass:[RCTextMessage class]]) {
        ...
        [MyDownLoadManager postUrl:[NSString stringWithFormat: @"%@/feedBack/talkToHelper",WEBAR_IP] withParameters:dic whenProgress:^(NSProgress *FieldDataBlock) {
        ...
        [MyDownLoadManager postUserInfoUrl:[NSString stringWithFormat: @"%@/feedBack/talkToHelper",WEBAR_IP] withParameters:dic fieldData:^(id<AFMultipartFormData> formData) {
